    ...
    <div className="space-y-8">
      ...
      <section id="methodology" className="scroll-mt-28 rounded-xl border border-neutral-200 bg-neutral-50 p-5 text-sm leading-relaxed text-neutral-600 dark:border-neutral-800 dark:bg-neutral-900/50 dark:text-neutral-400">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li><strong>Views ≠ positions.</strong> Takes marked 📌 are clear in/out calls (&quot;I&apos;d own it here&quot;, &quot;take profits&quot;) and are the only ones that trade in the host funds; criticism and commentary are surfaced and judged as views but never open or close a simulated position.</li>
